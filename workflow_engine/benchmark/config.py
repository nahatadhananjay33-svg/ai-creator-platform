...
class WorkflowBenchmarkConfig:
    ...
    fps: int = 30                           # mock render cost scales with fps x duration
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "profiles": list(self.profiles), "fps": self.fps,
            "rebuild_stage": self.rebuild_stage, "repetitions": self.repetitions,
        }
